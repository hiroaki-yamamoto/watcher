...
namespace ui {
    PluginPanel::PluginPanel(const QString &title, const QString &author,
                             const QString &description, const QIcon &icon,
                             plugin::root *plugin_root,
                             const bool pluginEnabled, QWidget *parent)
        : QWidget(parent) {
        ...
        connect(this->_enabled, SIGNAL(clicked(bool)),
                SLOT(setPluginEnabled(bool)));
        connect(this->_enabled, SIGNAL(clicked(bool)),
                SIGNAL(enableChanged(bool)));
    }
    QString PluginPanel::pluginTitle() const {
        return this->_pluginTitle->text();
    }
    QString PluginPanel::pluginDesc() const {
        return this->_pluginDesc->text();
    }
    QString PluginPanel::pluginAuthor() const { return this->_author->text(); }
    QString PluginPanel::pluginVersion() const {
        return this->_version->text();
    }
    void PluginPanel::setPluginTitle(const QString &title) {
        this->_pluginTitle->setText(title);
    }
    void PluginPanel::setPluginDesc(const QString &desc) {
        this->_pluginDesc->setText(desc);
    }
    void PluginPanel::setPluginVersion(const QString &version) {
        this->_version->setText(version);
    }
    bool PluginPanel::pluginEnabled() const {
        return this->_enabled->isChecked();
    }
    ...
    void PluginPanel::setPluginAuthor(const QString &author) {
        this->_author->setText(author);
    }

    const plugin::root *PluginPanel::plugin_instance() const {
        return this->_plugin_root;
    }
}
