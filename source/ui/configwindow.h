...
namespace ui {
    ...
    class ConfigDialog : public QDialog, private Ui::ConfigDialog_template {
       ...
       public:
        ConfigDialog(storage::property_storage *property,
                     ...
                     QMLWindowBase *QMLParent = nullptr,
    ...
    slots:
       ...
       private:
        ...
        /*This function shows copy confirmation dialog and copy/move files in
         *previous.
         *When copying/moving has succeeded, this function returns true.
         *Otherwise, returns false.
         */
        bool _confirm_and_copy_move(QDir previous, const QDir current,
                                    bool *actual_copied = nullptr);
    ...
    slots:
        ...
        void _pluginFilePathChanged(const QFileInfo &previous,
                                    const QFileInfo &now, bool &cancel);
        void _themeFilePathChanged(const QFileInfo &previous,
                                   const QFileInfo &now, bool &cancel);
