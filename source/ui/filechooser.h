...
namespace ui {
    class FileChooser : public QWidget {
       ...
       public:
        ...
        FileChooser(const QString &objName = QString(),
                    QWidget *parent = nullptr);
        FileChooser(const QFileInfo &file_path = QFileInfo(),
                    const ChooseMode mode = FileChooser::File,
    ...
    signals:
        void filePathChanged(const QFileInfo &previous, const QFileInfo &now,
                             bool &cancel);
       public
    slots:
