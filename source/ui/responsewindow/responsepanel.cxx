...
namespace ui {
    ResponsePanel::ResponsePanel(const plugin::response *res,
                                 ResponseView *parent)
        : QObject(parent) {
        this->_response = res;
        this->_item = parent->_addItem(
            this->title(), this->author(), this->email(), this->post_time(),
            this->body(), this->UUID(), this->responseURL(), this->imageInfo());
    }
    ...
    QDateTime ResponsePanel::post_time() const {
        return this->_response->creation_date();
    }
    ...
    QUrl ResponsePanel::responseURL() const {
        return this->_response->response_url();
    }
    manager::ImageManager *ResponsePanel::imageInfo() const {
        return this->_response->images();
    }
