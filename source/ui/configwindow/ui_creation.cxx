...
namespace ui {
    void ConfigDialog::_create_LayoutsInGeneralPanel() {
        ...
        // Default margins are too large. (By default, 11 pixels in all
        // directions.)
        ...
        this->_pluginPathLabel->setSizePolicy(QSizePolicy::Fixed,
                                              QSizePolicy::Preferred);
        this->_themePathLabel->setSizePolicy(QSizePolicy::Fixed,
                                             QSizePolicy::Preferred);

        // Set background colors of plugin list and theme list. (Default color
        // is dark...)
        ...
        this->_plugin_dir = new ui::FileChooser(
            QFileInfo(
                this->_property->get(default_value::setting_default::
                                         name_plugin_root_dir()).toString()),
            ui::FileChooser::Dir, "Plugin Root Directory", this);
        this->_theme_dir = new ui::FileChooser(
            QFileInfo(
                this->_property
                    ->get(default_value::setting_default::name_theme_root_dir())
                    .toString()),
            ui::FileChooser::Dir, "Theme Root Directory", this);
    }
}
