...
#include<cassert>
namespace ui{
    ConfigDialog::ConfigDialog(storage::property_storage *property, loader::plugin_loader *loader, QMLWindowBase *QMLParent, QWidget *parent)
        :QDialog(parent){
        ...
        this->_clear_disabled_plugins_list=this->_clear_selected_theme=false;
