    ...
    void ConfigDialog::closeEvent(QCloseEvent *event) {
        ...
        if (require_reboot) {
            QMessageBox::StandardButton &&result = QMessageBox::question(
                this, tr("Setting modification restarting required"),
            ...
            switch (result) {
                case QMessageBox::Yes:
                    if (this->_parent != nullptr)
                        this->_parent->restartApplication();
                    else
                        qWarning() << this << "Restarting failed. "
                                              "QMLWindowBase parent couldn't "
                                              "be found!";
                    break;
                default:
                    break;
