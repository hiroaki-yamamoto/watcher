...
namespace ui {
    class PluginPanel : public QWidget, private Ui::pluginpanel {
        ...
        Q_PROPERTY(QString pluginVersion READ pluginVersion WRITE
                       setPluginVersion)
       ...
       public:
        PluginPanel(const QString &title, const QString &author,
                    const QString &description, const QIcon &icon,
                    plugin::root *plugin_root, const bool pluginEnabled,
