...
namespace yotsuba{
    ...
    void root::get_categories(){
        ...
        int random_number;
        yotsuba::category *ws_board=new yotsuba::category(this->_mt,this),*wus_board=new yotsuba::category(this->_mt,this);
        ...
        ws_board->setIdentifier(QUuid::createUuidV5(this->identifier(),
                                                    QByteArray((char *)&random_number,sizeof(random_number))));
        random_number=this->random_number();
        wus_board->setTitle(tr("Unsafe Boards for Work"));
        wus_board->setDescription(tr("BE CAREFUL; You'll be FIRED when you watch these boards at working time."));
        wus_board->setIdentifier(QUuid::createUuidV5(this->identifier(),
                                                     QByteArray((char *)&random_number,sizeof(random_number))));
