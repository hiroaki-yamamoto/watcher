...
namespace plugin{
    ...
    //You need to implement to their pure-virtual function and the pure-virtual function of this class.
    class content_base:public QObject{
            using QObject::QObject;
        public:
            //Name of the content.
            virtual const QString &title() const final;
            //If description doesn't exist, you don't need to implement this function.
            virtual const QString &description() const final;
            virtual QObject *this_object();
            //The UUID of this class will be generated by the constructor of this class. You cannot override this function.
