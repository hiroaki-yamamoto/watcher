...
namespace storage {
    ...
    class property_storage : public QObject {
       ...
       public:
        property_storage(const int element_size = 10,
                         const QString &objName = QString(),
                         QObject *parent = nullptr);
        /*
         * Copies entire elements.
         * Unlike differencial_copy described below, this constructor copies the
         * "entire" elements in other.
         */
        property_storage(const property_storage &other,
    ...
    slots:
        ...
        void clear();
        // Copies the most recently registerd element in setting if the key
        // doesn't exist.
    ...
    slots:
         ...
         *
         * Moreover, this function is called automatically when set member
         *funciton in this class is called.
         * (i.e. it is NOT always called when the number of elements in __data
         *is changed)
         */
