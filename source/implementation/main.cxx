...
//version is made by create_version. It is a bash script to retrieve git commit.
#include <version>
...
int main(int argc,char **argv){
    ...
    loader::setting_loader setting(default_value::setting_default::setting_path().filePath(),5,"Watcher core setting");
    setting.read();
    QString &&plugin_root_dir=setting.storage()[default_value::setting_default::name_plugin_root_dir()].toString();
